...
app.whenReady().then(async () => {
  ...
  /**
   * An electron protocol that handles requests from the renderer process to realive:///host/path
   * https://www.electronjs.org/docs/latest/api/protocol
   * Currently only supports the "cards" host realive:///cards/path
   *
   ...
   * So fetch(realive:///cards/whatever/path) will be rejected
   * Instead use <img src="realive:///host/path"
   *
   * @example
   * Example usage in renderer:
   * <img src="realive:///cards/some_char/avatar.png"/>
   * <img src="realive:///cards/some_other_char/banner.png"/>
   *
   */
  protocol.handle("realive", (req) => {
