...
// Seed db
const dbPath = join(app.getPath("appData"), "realive", "realive.db");
...
console.log("Database seeded successfully." + dbPath);

// Seed blob storage data
const src = join(cwd, "/scripts/blob");
const dest = join(app.getPath("appData"), "realive", "blob");
